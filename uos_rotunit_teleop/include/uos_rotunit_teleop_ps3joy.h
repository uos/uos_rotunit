...
#ifndef UOS_ROTUNIT_TELEOP_PS3JOY_H
#define UOS_ROTUNIT_TELEOP_PS3JOY_H
...
class RotunitTeleopPS3Joy{

  public:
    RotunitTeleopPS3Joy(ros::NodeHandle &nh);
...
#endif /* uos_rotunit_teleop_ps3joy.h */
